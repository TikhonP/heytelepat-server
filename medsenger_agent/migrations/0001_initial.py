    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE,
                                               to='medsenger_agent.contract')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medsenger_agent.contract')),
            ],
        ),
        migrations.CreateModel(
